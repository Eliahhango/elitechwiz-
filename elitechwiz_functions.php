...
function ew_enforce_integrity($rootDir){
  ...
  if (!file_exists($manifestPath)) {
    ...
    echo $yellow . "[!] Please use the original repository or a fork from: https://github.com/Eliahhango/elitechwiz-\n" . $cln;
    exit(1);
  }
  ...
  if (!empty($missing) || !empty($modified)) {
    ...
    echo $yellow . "[!] Please use or fork: https://github.com/Eliahhango/elitechwiz-\n" . $cln;
    exit(1);
  }
}
